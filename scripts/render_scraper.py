...
def run_scrape_round():
    ...
    # JobSpy at the end with ALL job categories
    js_keywords = [
        # Tech / IT
        ...
        "web developer", "UI UX designer", "QA engineer",
        "network engineer", "system administrator", "database administrator",
        "IT support", "IT manager", "cybersecurity analyst",
        "blockchain developer", "game developer", "AR VR developer",
        "technical writer", "scrum master", "product owner",
        # Healthcare
        "registered nurse", "licensed practical nurse", "nurse practitioner",
        "medical assistant", "phlebotomist", "dental hygienist",
        "pharmacist", "pharmacy technician", "medical technician",
        "physical therapist", "occupational therapist", "respiratory therapist",
        "radiology technician", "ultrasound technician", "medical biller",
        "medical coder", "healthcare administrator", "clinical research",
        "medical records", "patient care", "home health aide",
        "CNA certified nursing assistant", "EMT paramedic",
        "speech pathologist", "audiologist", "optometrist",
        "veterinary technician", "veterinarian", "surgical technician",
        "dental assistant", "physician assistant", "hospital administrator",
        # Blue Collar / Trades
        "electrician", "plumber", "carpenter", "welder",
        "HVAC technician", "mechanic", "auto mechanic", "diesel mechanic",
        ...
        "delivery driver", "truck driver", "CDL driver", "forklift operator",
        "pipefitter", "ironworker", "mason", "painter",
        "roofer", "drywall installer", "flooring installer",
        "landscaper", "arborist", "pest control technician",
        "appliance repair technician", "elevator mechanic", "solar panel installer",
        # Manufacturing / Industrial
        "manufacturing associate", "assembly line worker", "quality control inspector",
        "CNC machinist", "maintenance technician", "industrial electrician",
        "plant manager", "production supervisor", "supply chain manager",
        "production planner", "inventory control specialist", "purchasing agent",
        # Office / Administrative
        "office manager", "office assistant", "office clerk",
        "receptionist", "front desk", "administrative assistant",
        "executive assistant", "paralegal", "legal secretary",
        "bookkeeper", "accountant", "accounts payable", "accounts receivable",
        "financial analyst", "payroll specialist", "HR manager",
        "human resources", "recruiter", "talent acquisition",
        "training coordinator", "benefits administrator", "compensation analyst",
        "project manager", "business analyst", "operations manager",
        "quality assurance", "compliance officer", "procurement specialist",
        # Sales / Marketing
        ...
        "brand manager", "public relations", "media buyer",
        "email marketing", "PPC specialist", "affiliate marketing",
        "retail sales associate", "store manager", "cashier",
        # Customer Service
        "customer service representative", "call center agent",
        "customer support specialist", "help desk technician",
        "technical support specialist", "chat support agent",
        "service desk analyst", "client services coordinator",
        # Hospitality / Food
        "hotel front desk", "hotel manager", "housekeeping supervisor",
        "chef", "line cook", "prep cook", "kitchen manager",
        "bartender", "server", "waiter waitress", "food runner",
        "restaurant manager", "restaurant supervisor", "catering coordinator",
        "food service worker", "cafeteria worker", "dishwasher",
        # Retail
        "retail manager", "assistant store manager", "visual merchandiser",
        "loss prevention officer", "stock associate", "inventory specialist",
        "checkout clerk", "greeter", "customer service desk",
        # Transportation / Logistics
        "supply chain analyst", "procurement manager", "operations coordinator",
        "fleet manager", "dispatch coordinator", "routing specialist",
        "customs broker", "freight broker", "shipping clerk",
        "mail carrier", "postal worker", "package handler",
        "bus driver", "taxi driver", "uber driver",
        # Real Estate / Property
        "real estate agent", "property manager", "leasing agent",
        "real estate broker", "title examiner", "appraiser",
        "escrow officer", "property inspector", "maintenance supervisor",
        # Education
        "teacher", "teacher assistant", "substitute teacher",
        "tutor", "school counselor", "librarian",
        "special education teacher", "preschool teacher", "daycare worker",
        "campus security", "custodian", "school bus driver",
        "college professor", "academic advisor", "registrar",
        # Government / Public Safety
        "police officer", "firefighter", "corrections officer",
        "security guard", "security officer", "armed security",
        "dispatcher", "911 operator", "court clerk",
        "social worker", "case manager", "probation officer",
        "inspector", "building inspector", "code enforcement officer",
        "park ranger", "municipal clerk", "zoning administrator",
        # Finance / Banking
        "bank teller", "bank manager", "loan officer",
        "financial advisor", "wealth manager", "insurance agent",
        "underwriter", "claims adjuster", "actuary",
        "credit analyst", "auditor", "tax preparer",
        "investment banker", "portfolio manager", "trading analyst",
        # Media / Creative
        "videographer", "photographer", "editor",
        "journalist", "news anchor", "producer",
        "animator", "illustrator", "web designer",
        "video editor", "sound engineer", "lighting technician",
        "stagehand", "event coordinator", "wedding planner",
        # Energy / Utilities
        "power plant operator", "lineman", "utility worker",
        "oil field worker", "drilling engineer", "refinery operator",
        "nuclear technician", "wind turbine technician", "water treatment operator",
        # Agriculture
        "farm worker", "ranch hand", "agricultural technician",
        "irrigation specialist", "pest management specialist", "horticulturist",
        "livestock handler", "dairy worker", "greenhouse worker",
        # Aviation / Maritime
        "pilot", "flight attendant", "aircraft mechanic",
        "air traffic controller", "ground crew", "baggage handler",
        "marine mechanic", "dock worker", "longshoreman",
        # Miscellaneous
        "cleaning janitor", "housekeeper", "maid service",
        "pest control", "funeral director", "embalmer",
        "animal caretaker", "dog groomer", "pet sitter",
        "personal trainer", "fitness instructor", "yoga instructor",
        "barber", "hairstylist", "nail technician",
        "tattoo artist", "piercing specialist",
        "moving company", "junk removal", "handyman",
        "locksmith", "key maker", "auto glass repair",
        "detailer car wash", "tire technician", "brake technician",
    ]
    js_locations = [
        "Remote", "New York", "San Francisco", "Austin", "Los Angeles",
        "Chicago", "Houston", "Phoenix", "Philadelphia", "San Antonio",
        "San Diego", "Dallas", "San Jose", "Austin Texas", "Jacksonville",
        "Fort Worth", "Columbus", "Charlotte", "Indianapolis", "San Francisco Bay Area",
        "Seattle", "Denver", "Boston", "Nashville", "Portland",
        "Las Vegas", "Atlanta", "Miami", "Minneapolis", "Tampa",
        "Detroit", "Phoenix Arizona", "Orlando", "Charlotte NC", "Pittsburgh",
        "Sacramento", "St Louis", "Cincinnati", "Kansas City", "Columbus Ohio",
        "London", "Manchester", "Birmingham", "Edinburgh", "Glasgow",
        "Toronto", "Vancouver", "Montreal", "Calgary", "Ottawa",
        "Bangalore", "Mumbai", "Delhi", "Hyderabad", "Pune",
        "Chennai", "Noida", "Gurgaon", "Ahmedabad", "Jaipur",
        "Kolkata", "Coimbatore", "Kochi", "Indore", "Bhopal",
        "Singapore", "Dubai", "Sydney", "Melbourne", "Berlin",
        "Amsterdam", "Dublin", "Paris", "Tokyo", "Seoul",
    ]
